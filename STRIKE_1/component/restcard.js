...
export default function Restcard({restInfo}){
    return(
        ...
        <div className="max-w-sm flex-none">
            <Link to={"/city/patna/"+restInfo?.info?.id}  className="block max-w-[280px] mb-2 transform transition duration-200 hover:scale-95" >

          {/* <img className="w-80 h-50 object-cover rounded-xl" src={"https://media-assets.swiggy.com/swiggy/image/upload/"+restInfo.info.cloudinaryImageId}></img> */}
